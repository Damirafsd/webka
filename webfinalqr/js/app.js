...
const handleOnMove = e => {
  ...
  let body = document.querySelector('body');
  let bg2Position =  Math.abs(body.getBoundingClientRect().top - bg2.getBoundingClientRect().top);
  let bg2BottomPosition =  Math.abs(body.getBoundingClientRect().top - bg2.getBoundingClientRect().bottom);
  //console.log(e.pageY, bg2Position);
  if(e.pageY > bg2Position && e.pageY < bg2BottomPosition){
